...
<head>
  ...
  <title>Trias ETH/TRY Wallet</title>
...
<body>
  ...
  <header class="{{curNode.name}} {{curNode.service}} {{curNode.service}} nav-index-{{gService.currentTab}}" aria-label="header"
  ...
  <div class="small announcement annoucement-danger">
    ...
    <div class="warning-banner">
      ...
      <span>This version is a beta version and does not provide any security for the data.</span>
    </div>
        ...
        <div class="language-change tagline">
          ...
          <span class="dropdown dropdown-wallet" ng-cloak>
            <a tabindex="0" aria-haspopup="true" aria-expanded="false"
              class="dropdown-toggle hidden-xs" ng-click="dropdownWallet = !dropdownWallet" >ETH/TRY Wallet<i class="caret"></i></a>
            ...
            <ul class="dropdown-menu" ng-show="dropdownWallet">
              <li><a class="active" href=""> ETH/TRY Wallet </a></li>
              <li><a href="https://wallet.trias.one/" target="_blank" > Testnet Wallet </a></li>
              <li><a href="https://btcwallet.trias.one" translate="BTC_Wallet" target="_blank" > BTC Wallet </a></li>
            </ul>
          </span>
          ...
          <span class="dropdown dropdown-lang" ng-cloak>
            ...
            <ul class="dropdown-menu" ng-show="dropdownLang">
              ...
              <li><a ng-class="{true:'active'}[curLang=='English']" ng-click="changeLanguage('en','English'        )">
                  English </a></li>
              ...
              <li><a ng-class="{true:'active'}[curLang=='简体中文']" ng-click="changeLanguage('zhcn','简体中文'      )"> 简体中文
                </a></li>
    ...
    <div class="tagline header-navbar-title">

      <!-- <span class="hidden-xs">3.21.22</span> -->
      <span class="dropdown trias-title">
        Trias Wallet
        <i class="fa fa-thumbs-up"></i>
        <span class="trias-fondation">by Trias-lab Foundation</span>
      </span>

      <span class="dropdown dropdown-gas" ng-cloak>
        <a tabindex="0" aria-haspopup="true" aria-label="adjust gas price" class="dropdown-toggle  btn btn-white select-gas-btn"
        ...
        <ul class="dropdown-menu" ng-show="dropdownGasPrice">
          <div class="header--gas">
            ...
            <a class="small" translate="x_ReadMore" href="https://myetherwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html"
      ...
      <span class="dropdown dropdown-node" ng-cloak>
        <a tabindex="0" aria-haspopup="true" aria-label="change node. current node {{curNode.name}} node by {{curNode.service}}"
          class="dropdown-toggle  btn btn-white select-node-btn" ng-click="dropdownNode = !dropdownNode">
        ...
        <ul class="dropdown-menu" ng-show="dropdownNode">
          <li ng-repeat="(key, value) in nodeList">
            <a ng-class="{true:'active'}[curNode == key]" ng-click="changeNode(key)">
              ...
              <img ng-show="value.service=='Custom'" src="images/icon-remove.svg" class="node-remove" title="Remove Custom Node"
    ...
    <nav role="navigation" aria-label="main navigation" class="container nav-container overflowing">
      <a aria-hidden="true" ng-show="showLeftArrow" class="nav-arrow-left" ng-click="scrollLeft(100);" ng-mouseover="scrollHoverIn(true,2);"
        ng-mouseleave="scrollHoverOut()">&#171;</a>
      <div class="nav-scroll">
        <ul class="nav-inner">
          @@if (site === 'mew' ) {
          <li ng-repeat="tab in tabNames track by $index" \ class="nav-item {{tab.name}}" \ ng-class="{active: $index==gService.currentTab}"
            ng-show="tab.mew" ng-click="tabClick($index)">
            <a tabindex="0" aria-label="nav item: {{tab.name | translate}}" translate="{{tab.name}}"></a>
          </li>
          }
          @@if (site === 'cx' ) {
          <li ng-repeat="tab in tabNames track by $index" \ class="nav-item {{tab.name}}" \ ng-class="{active: $index==gService.currentTab}"
            ng-show="tab.cx" ng-click="tabClick($index)">
            <a tabindex="0" aria-label="nav item: {{tab.name | translate}}" translate="{{tab.name}}"></a>
          </li>
          }
      ...
      <a aria-hidden="true" ng-show="showRightArrow" class="nav-arrow-right" ng-click="scrollRight(100);" ng-mouseover="scrollHoverIn(false,2);"
        ng-mouseleave="scrollHoverOut()">&#187;</a>
    </nav>
