<section class="swap-panel" ng-show="!isKyberSwap">
    ...
    <section class="" ng-show="!isKyberSwap " ng-controller='sendTxCtrl'>
        ...
        <div class="swap-panel" ng-class="wallet!=null ? 'step-card active':'step-card'">
            <div class="swap-panel-tit" ng-class="!isKyberSwap && !wd ?'swap-panel-tit':'swap-panel-tit not-slect'">
        ...
        @@if (site === 'mew' ) { @@include( './sendTx-modal.tpl', { "site": "mew" } ) } @@if (site === 'cx' ) { @@include( './sendTx-modal.tpl',
        { "site": "cx" } ) }
    </section>
</section>