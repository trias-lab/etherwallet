<article  class="modal fade swap-modal" id="sendTransaction" tabindex="-1"  ng-controller='swapModalCtrl'>
    <section class="modal-dialog" style="transform: translateY(0%)">
        <section class="modal-content">
                ...
                <table class="table small table-condensed table-hover transaction-modal">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="small text-left mono"> {{parsedSignedTx.txFee.eth}} ETH <small>({{parsedSignedTx.txFee.gwei}}
                                    GWEI)</small></td>
                        </tr>
                        <tr>
            ...
            <div class="modal-footer">
                ...
                <br />
                <button class="btn btn-primary" ng-click="sureClick()" translate="SENDModal_Yes" style="float:right;">
